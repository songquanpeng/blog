...
func (a *App) rawPageContent(c *gin.Context) {
	...
	document.WriteString("</title><link rel=\"stylesheet\" href=\"/static/bulma.min.css\"><link rel=\"stylesheet\" href=\"/static/main.css?v=profile-card-20260831\">")
	if theme == publicThemeStudio {
		document.WriteString("<link rel=\"stylesheet\" href=\"/theme/studio/main.css?v=studio-profile-card-20260831\">")
	}
