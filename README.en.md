...
A single-owner blog built with Gin, GORM, React, and Bulma. Public pages are server-rendered for SEO and can switch instantly between classic Bulma and Studio Song, a neutral charcoal-and-paper editorial theme with Chinese serif typography; GitHub OAuth remains the exclusive admin login.
