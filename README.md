...
- 公开站点可在经典 Bulma 与 Studio 宋韵主题之间即时切换；Studio 使用黑灰与暖纸白的散文式视觉，以及更适合中文长文的宋体排版。
...
Studio 宋韵采用暖纸白、炭黑与中性灰，不使用彩色强调；首页以文章目录式分隔取代卡片堆叠，导航与中文正文优先使用系统自带的 `Songti SC`、`STSong` 或 `SimSun`，元信息使用系统无衬线字体，代码仍使用等宽字体。
